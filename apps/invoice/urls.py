...
urlpatterns = [
    ...
    path('invoices/<int:invoice_id>/get_e_reporting_status/', get_e_reporting_status, name='get_e_reporting_status'),
    path('invoices/<int:invoice_id>/prepare_e_reporting/', prepare_e_reporting, name='prepare_e_reporting'),
    path('invoices/<int:invoice_id>/send_e_reporting/', send_e_reporting, name='send_e_reporting'),
